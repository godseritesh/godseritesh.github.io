          ...
          <ContainerAnimation>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
                Graduate Trainee Engineer specializing in high-performance FinTech systems, distributed architectures, and AI-driven solutions. I focus on quantifiable impact and clarity in every project.
              </p>
            </div>
          </ContainerAnimation>
